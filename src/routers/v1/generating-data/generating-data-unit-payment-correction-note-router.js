                    ...
                    for (var _data of list) {
                        for (var item of _data.items) {
                            ...
                            var _item = {
                                ...
                                "TANGGAL FAKTUR PAJAK KOREKSI PPN ": moment(new Date(_data.incomeTaxCorrectionDate)).format(dateFormat),
                                "FAKTUR PAJAK KOREKSI PPH": _data.vatTaxCorrectionNo,
                                "TANGGAL FAKTUR PAJAK KOREKSI PPH ": moment(new Date(_data.vatTaxCorrectionDate)).format(dateFormat),
                                ...
                                "NOMOR SURAT PENGANTAR": moment(new Date(_data.returNoteNo)).format(dateFormat),
